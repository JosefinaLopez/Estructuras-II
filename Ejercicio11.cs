...
namespace Ejercicio11
{
    class Mayor
    {
        ...
        static int ImprimirMenor(Nodo nodo, ref int mayor)
        {
            if (nodo == null)
            {
                return 0;
            ...
            else
            {
                ...
                ImprimirMenor(nodo.Izquierda, ref mayor);
                ImprimirMenor(nodo.Derecha, ref mayor);
            }
            return mayor;
        }
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("4. Imprimir Mayor");
                ...
                switch (opcion)
                {
                    ...
                    case 4:
                        ...
                        int xd = ImprimirMenor(raiz, ref mayor);
